...
class topic(models.Model):
    ...
    essence_flag = models.BooleanField(default=False)
...
class node(models.Model):
    theme = models.ForeignKey('theme', related_name='nodes')
...
class topic_collect(models.Model):
    user = models.ForeignKey(User, related_name='topic_collects')
    topic = models.ForeignKey(topic, related_name='topic_collects')
    deleted = models.BooleanField(default=False)
